...
export default function ReservationForm() {
  ...
  if (step === Steps.Landing) {
    return (
      <form
        // TODO: useFormState and action w/ validation
        // action={() => setStep(Steps.Calendly)}
        onSubmit={() => setStep(Steps.Calendly)}
  ...
  } else if (step === Steps.Calendly) {
    return <InlineWidget url="https://calendly.com/steadydatecoaching/30min" />
  }
}
